		...
		class Worker
			...
			def perform(csv, origin_message_id)
				...
				begin
					...
					msg_obj = Queclink::Gl300::Message.find origin_message_id
					...
					puts "ERROR handling gl300 origin_message_id (#{origin_message_id}): #{e}"
			...
			def handlePositionReport(header_type, fields, origin_message_id)
				...
				decode = Queclink::Gl300::Decoder.new
				...
				parsed_messages.each_with_index do |parsed_message, i|
					...
					parsed_message.origin_message_type = 'gl300'
